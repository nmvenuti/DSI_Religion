...
def runMaster(rawPath,groupList,crossValidate,groupSize,testSplit,targetWordCount,cocoWindow,svdInt,cvWindow,simCount,nCores):
    ###############################
...
if __name__ == '__main__':
    ...
    startTime=time.time()
    runMaster(rawPath,groupList,crossValidate,groupSize,testSplit,targetWordCount,cocoWindow,svdInt,cvWindow,simCount,nCores)
    endTime=time.time()
    print('finished entire run in :'+str((endTime-startTime)/60)+' minutes')
    sys.stdout.flush()
